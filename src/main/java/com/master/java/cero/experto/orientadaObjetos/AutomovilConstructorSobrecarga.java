...
public class AutomovilConstructorSobrecarga {
	...
	public AutomovilConstructorSobrecarga() {
	}
	
	public AutomovilConstructorSobrecarga(String fabricante, String modelo) {
	...
	public AutomovilConstructorSobrecarga(String fabricante, String modelo, String color) {
	//  this.fabricante = fabricante;
	//	this.modelo = modelo;
	...
	public AutomovilConstructorSobrecarga(String fabricante, String modelo, String color, double Cilindrada) {
	//	this.fabricante = fabricante;
	//	this.modelo = modelo;
	//	this.color = color;	
