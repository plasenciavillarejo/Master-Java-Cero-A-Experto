...
public class AutomovilToString {
	...
	/* Personalizamos el método toString()*/
	
	@Override
	public String toString() {
		return "AutomovilToString [fabricante=" + fabricante + ", modelo=" + modelo + ", color=" + color
				+ ", cilindrada=" + cilindrada + ", capacidadEstanque=" + capacidadEstanque + "]";
	}
	

	
	
	/* 1.- Vamos a realizar la sobrecarga de constructores. */
	
	public AutomovilToString() {
	}
	
	public AutomovilToString(String fabricante, String modelo) {
	...
	public AutomovilToString(String fabricante, String modelo, String color) {
	//  this.fabricante = fabricante;
	//	this.modelo = modelo;
	...
	public AutomovilToString(String fabricante, String modelo, String color, double Cilindrada) {
	//	this.fabricante = fabricante;
	//	this.modelo = modelo;
	//	this.color = color;	
